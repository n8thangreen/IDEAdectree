---
title: "IDEA study: TST and QFN cost-effectiveness comparison: Indeterminates included"
author: "Nathan Green"
...
IDEAdectree.simple.TSPOT <- function(...){IDEAdectree.simple(SPEC = TSPOT.Indet.spec.mean, SENS = TSPOT.Indet.sens.mean, 
                                                             SPECvar = TSPOT.Indet.spec.var, SENSvar = TSPOT.Indet.sens.var,
                                                             ...)}
IDEAdectree.simple.QFN <- function(...){IDEAdectree.simple(SPEC = QFN.Indet.spec.mean, SENS = QFN.Indet.sens.mean, 
...
![plot of chunk prevalence](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/prevalence-1.png)
...
![plot of chunk prevalence](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/prevalence-2.png)
...
![plot of chunk prevalence](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/prevalence-3.png)
...
![plot of chunk prevalence](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/prevalence-4.png)
...
![plot of chunk prevalence](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/prevalence-5.png)
...
![plot of chunk testcost](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/testcost-1.png)
...
![plot of chunk testcost](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/testcost-2.png)
...
![plot of chunk testcost](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/testcost-3.png)
...
![plot of chunk testcost](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/testcost-4.png)
...
![plot of chunk testcost](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/testcost-5.png)
...
![plot of chunk FNtimes](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/FNtimes-1.png)
...
![plot of chunk FNtimes](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/FNtimes-2.png)
...
![plot of chunk FNtimes](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/FNtimes-3.png)
...
![plot of chunk FNtimes](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/FNtimes-4.png)
...
![plot of chunk FNtimes](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/FNtimes-5.png)
...
![plot of chunk threshold](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/threshold-1.png)
...
![plot of chunk threshold](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/threshold-2.png)
...
![plot of chunk threshold](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/threshold-3.png)
...
![plot of chunk threshold](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/threshold-4.png)
...
![plot of chunk threshold](indiv-dectree_QFN_TSPOT-WITHindeterminates-RUNS_files/threshold-5.png)
