...
IDEAdectree.simple.TSPOT <- function(...){IDEAdectree.simple(SPEC = TSPOT.HIVneg.Indet.spec.mean, SENS = TSPOT.HIVneg.Indet.sens.mean, 
                                                             SPECvar = TSPOT.HIVneg.Indet.spec.var, SENSvar = TSPOT.HIVneg.Indet.sens.var,
                                                             ...)}
IDEAdectree.simple.QFN <- function(...){IDEAdectree.simple(SPEC = QFN.HIVneg.Indet.spec.mean, SENS = QFN.HIVneg.Indet.sens.mean, 
...
![plot of chunk prevalence](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/prevalence-1.png)
...
![plot of chunk prevalence](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/prevalence-2.png)
...
![plot of chunk prevalence](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/prevalence-3.png)
...
![plot of chunk prevalence](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/prevalence-4.png)
...
![plot of chunk prevalence](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/prevalence-5.png)
...
![plot of chunk testcost](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/testcost-1.png)
...
![plot of chunk testcost](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/testcost-2.png)
...
![plot of chunk testcost](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/testcost-3.png)
...
![plot of chunk testcost](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/testcost-4.png)
...
![plot of chunk testcost](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/testcost-5.png)
...
![plot of chunk FNtimes](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/FNtimes-1.png)
...
![plot of chunk FNtimes](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/FNtimes-2.png)
...
![plot of chunk FNtimes](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/FNtimes-3.png)
...
![plot of chunk FNtimes](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/FNtimes-4.png)
...
![plot of chunk FNtimes](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/FNtimes-5.png)
...
![plot of chunk threshold](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/threshold-1.png)
...
![plot of chunk threshold](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/threshold-2.png)
...
![plot of chunk threshold](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/threshold-3.png)
...
![plot of chunk threshold](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/threshold-4.png)
...
![plot of chunk threshold](indiv-dectree_QFN_TSPOT-HIVneg-WITHindeterminates-RUNS_files/threshold-5.png)
